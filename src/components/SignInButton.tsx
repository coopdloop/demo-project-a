    ...
    <>
      {session ? (
        <Menu as="div" className="relative">
          ...
          >
            <Menu.Items className="bg-gray-200 dark:text-react absolute right-0 mt-1 flex w-96 origin-top-right flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white">
              ...
              <Menu.Item>
                {({ active }) => (
                  <Link
                    href="/profile"
                    className={clsx(
                      active && "bg-stone-800/50 dark:bg-stone-200",
              ...
              <Menu.Item>
                {({ active }) => (
                  <Button
                    className={clsx(
                      active && "bg-stone-400/50 dark:bg-stone-200",
                      "inline-flex items-center gap-6 px-[34px] py-2 text-sm text-black dark:text-stone-500"
                    )}
                    onClick={() => signOut()}
                  >
        ...
        <Button
          className="rounded-md border border-stone-300 px-3 py-1 text-sm dark:border-stone-600 text-stone-600"
          onClick={() => signIn()}
        >
          Sign In
        </Button>
